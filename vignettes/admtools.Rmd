...
The package can be installed directly from _GitHub_ or from _CRAN_. Generally, the package deposited from CRAN will be the latest stable release, while the package on GitHub will be the version under development.
