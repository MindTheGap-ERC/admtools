...
The package can be installed from _GitHub_ or _CRAN_.

### From GitHub

To install the package directly from _GitHub_, first install the _remotes_ package if you have not done so yet:
