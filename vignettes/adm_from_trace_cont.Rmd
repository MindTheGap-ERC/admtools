...
sd_3He = runif(n = length(mean_3He), min = 0.1, max = 1) # standard deviation of 3He
...
plot(NULL,
     ...
     ylab = "3He observed")
lines(h, observed_flux()(h), type = "p", col = "red", pch = 3)
lines(h, observed_flux()(h), type = "p", col = "blue", pch = 19)
lines(h, observed_flux()(h), type = "p", col = "black")
```
